...
using ExerciseMicroService.Services;
using Moq;
using System;
...
namespace ExerciseTests
{
    ...
    {
        Mock<IExerciseRepository> mockRepo;
        ...
        {
            mockRepo.Setup(x => x.GetAllExercisesPaginationAsync(1, 5, "", false))
                .ReturnsAsync(GetExercises(0));
            var service = new ExerciseService(mapper, mockRepo.Object);
        ...
        {
            mockRepo.Setup(x => x.GetExerciseAsync(new Guid("7c2a51b6-ffd3-4f82-8e21-92ca4053a37e"), false))
                .ReturnsAsync(() => null);
            var service = new ExerciseService(mapper, mockRepo.Object);
        ...
        {
            mockRepo.Setup(x => x.GetExerciseAsync(new Guid("7c2a51b6-ffd3-4f82-8e21-92ca4053a37e"), true))
                .ReturnsAsync(() => null);
            var service = new ExerciseService(mapper, mockRepo.Object);
